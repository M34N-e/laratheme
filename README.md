...
'providers' => [
	...
	Simtabi\Theme\ThemeServiceProvider::class,
...
'aliases' => [
	...
	'Theme' => Simtabi\Theme\Facades\Theme::class,
...
~~~
php artisan vendor:publish --provider="Simtabi\Theme\ThemeServiceProvider"
~~~
...
## Using theme global
~~~php
use Simtabi\Theme\Contracts\Theme;
...
protected $routeMiddleware = [
    ...
    'setTheme' => \Simtabi\Theme\Middleware\ThemeLoader::class,
];
~~~
